...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    small: base + " px-4 py-2 md:py-x md:py-2.5 text-xs",
    round: base + " px-1 py-1 md:px-2 md:py-2 text-sm",
    secondary:
      "inline-block rounded-full text-sm font-semibold uppercase tracking-wide text-stone-500 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed border-2 border-stone-300 px-4 py-2.5 md:px-6 sm:py-3.5",
  };
